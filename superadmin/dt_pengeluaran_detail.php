                 ...
                 <div class="x_content">
                   ...
                   <form class="form-horizontal form-label-left" action="#">
                     ...
                     <div class="item form-group">
                       <label class="control-label col-md-3 col-sm-3 col-xs-12">ID Pemasukan</label>
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         <input class="form-control col-md-7 col-xs-12" type="text" name="" value="<?php echo $row['id_pengeluaran']; ?>" readonly>
                       </div>
                     </div>
                     <div class="item form-group">
                     ...
                     <div class="form-group">
                       <div class="col-md-6 col-md-offset-3">
                         <a class="btn btn-primary" href="dt_pengeluaran.php">Kembali</a>
                       </div>
                     </div>
